                                                ...
                                                <tbody>
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            echo "<tr><td scope='row'>" . $row["id"] . "</td><td>" . $row["nom"] . "</td><td>" . $row["description"] . "</td>";
                                                            echo "<td><a href='models.php?mod=" . $row["id"] . "'>modifier</a> | <a href='apiModels.php?del=" . $row["id"] . "'>Supprimer</a></td></tr>";
                                                        }
                                                    } else {
                                                        echo "0 resultats";
                                                    }
